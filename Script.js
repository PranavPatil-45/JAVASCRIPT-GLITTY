...
///////////////////////////////////////////////////////Sort LOW TO HIGH MACBOOK CASES/////////////////////////////////////////////
let SortLowToHigh =document.getElementById('LowBTN');

SortLowToHigh.addEventListener('click',()=>{
  fetch("http://localhost:3000/MacBookCases")
  .then((res)=>res.json())
  .then((data)=>{
    let LowToHighData= data.sort((a,b)=>a.price - b.price)
    MacBookCaseCardList(LowToHighData);
  })
  .catch((err)=>console.log(err))
})
...
/////////////////////////////////////////////////////////Sort HIgh To Low Macbook Cases///////////////////////////////////////////////////

let SortHightoLow=document.getElementById('HighBTN');

SortHightoLow.addEventListener('click',()=>{
  fetch("http://localhost:3000/MacBookCases")
  .then((res)=>res.json())
  .then((data)=>{
    let HighToLowData =data.sort((a,b)=> b.price - a.price)
    MacBookCaseCardList(HighToLowData);
  })
  .catch((err)=>console.log(err))
})
...
////////////////////////////////////////////////////////////Sort For MAcbook skin///////////////////////////////////////////////////////

let LowToHighSkin = document.getElementById('LowBTNSkin');
LowToHighSkin.addEventListener('click',()=>{
  fetch("http://localhost:3000/MacBookSkins")
  .then((res)=>res.json())
  .then((data)=>{
    let LowToHighDataSkin= data.sort((a,b)=>a.price - b.price)
   MAcBookSkinCardList(LowToHighDataSkin);
  })
  .catch((err)=>console.log(err))
})
//////////////////////////////////////////////////////////Sort FOr Macbook skin High To low/////////////////////////////////////////////////
let HighToLowSkin=document.getElementById('HighBTNSkin');

HighToLowSkin.addEventListener('click',()=>{
  fetch("http://localhost:3000/MacBookSkins")
  .then((res)=>res.json())
  .then((data)=>{
    let HighToLowDataSkin= data.sort((a,b)=> b.price - a.price)
    MAcBookSkinCardList(HighToLowDataSkin)
  })
  .catch((err)=>console.log(err))
})
